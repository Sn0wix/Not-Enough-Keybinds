...
public class BasicLayoutWidget implements LayoutWidget {
    ...
    public void refreshPositions() {
        ...
        this.header.setMinHeight(this.screen.width);
        this.header.setMinWidth(i);
        this.header.setPosition(0, 0);
        this.header.refreshPositions();
        this.footer.setMinHeight(this.screen.width);
        this.footer.setMinWidth(j);
        this.footer.refreshPositions();
        this.footer.setY(this.screen.height - j);
        this.body.setMinHeight(this.screen.width);
